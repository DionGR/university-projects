        ...
        for epoch in range(num_epochs):
            ...
            for X_batch, Y_batch in iter(train_loader):
                ...
                if global_step % num_steps_per_val == 0:
                    ...
                    # Implement early stopping after 10 steps of degradation 
                    ...
                    if degradation_steps >= num_steps_degradation:
                        print(f"Maximum loss degradation reached - stopping at epoch {epoch}/{num_epochs}.")
