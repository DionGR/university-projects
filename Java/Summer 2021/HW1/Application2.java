...
public class Application2 {
    ...
    public static void main(String args[]) {
        ...
        System.out.println("\n\nQ2 - Factorial (n)");
        System.out.print("n = ");
        System.out.println("\n" + "Factorial (" + (n = input.nextInt()) + ") = " + ob.factorial(n));
        ...
        System.out.print("k = ");
        k = input.nextInt();
        System.out.println("Combinations(" + n + "," + k + ") = " + ob.combinations(n, k));
        ...
        System.out.print("n = ");
        n = input.nextInt();
        System.out.println("Number of digits = " + ob.digitsOfInteger(n));
        ...
        System.out.print("Enter c: ");
        c = input.nextDouble();
        System.out.printf("The area of a triangle is: %.2f", ob.findArea(a, b, c));

        // ---------------- Q7 ----------------------------
        System.out.println("\n\nQ7 - Reverse digits");
        System.out.print("Enter a positive integer:\nn = " );
        n = input.nextInt();
        System.out.println("The reversed number is = " + ob.reverseDigits(n));

        // ---------------- Q8 ----------------------------
        System.out.println("\n\nQ8 - Min Digit");
        System.out.print("Enter a positive integer:\nn = " );
        n = input.nextInt();
        System.out.println("Min Digit = " + ob.minDigit(n));
